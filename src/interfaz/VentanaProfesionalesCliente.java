...
public class VentanaProfesionalesCliente extends JFrame {

    private JTable tablaProfesionales;
    private DefaultTableModel modelo;

    public VentanaProfesionalesCliente(ArrayList<Profesional> profesionales) {

        setTitle("Profesionales Disponibles");
